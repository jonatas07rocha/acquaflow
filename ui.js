...
const widgetTemplates = {
    ...
    // WIDGET SIMPLIFICADO - AGORA É APENAS O HISTÓRICO
    activity: (state) => `
        <section data-widget-id="activity" class="widget glass-panel rounded-2xl p-4 mb-4 animate-on-scroll relative">
            ...
            <div class="flex items-center mb-3">
                 <div class="p-2 rounded-full mr-3 bg-[color-mix(in_srgb,var(--color-accent)_30%,transparent)]"><i data-lucide="history" class="w-4 h-4 text-[var(--color-accent-light)]"></i></div>
